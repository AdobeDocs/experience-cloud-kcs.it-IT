...
Puoi sfruttare [!UICONTROL Pannello di controllo Campaign] per controllare utilizzato rispetto all&#39;archiviazione gratuita del database 24/7. Fai riferimento a [https://experienceleague.adobe.com/docs/control-panel/using/performance-monitoring/database-monitoring/database-monitoring.html?lang=en](https://experienceleague.adobe.com/docs/control-panel/using/performance-monitoring/database-monitoring/database-monitoring.html?lang=en) per saperne di più.



Nota: per accedere a , sarà necessario disporre dei diritti di amministratore in Experience Cloud [!UICONTROL Pannello di controllo Campaign].
