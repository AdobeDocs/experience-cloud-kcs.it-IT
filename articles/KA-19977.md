...
# Disattivazione della [!DNL Dispatcher] Distribuzione
...
Espandi un commento o rimuovi il [!DNL Dispatcher] modulo dal `pom.xml` file (vedi sotto). Quindi riattiva la pipeline che salterà la [!DNL Dispatcher] modifica e distribuisce solo AEM base di codice su editore e autore.
