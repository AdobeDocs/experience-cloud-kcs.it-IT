...
11. Ottimizzazione dello storage Mongo
   ...
   - <b>Implementa l’elenco di controllo per la produzione di MongoDB:</b>\
      [http://docs.mongodb.org/manual/administration/production-checklist/](http://docs.mongodb.org/manual/administration/production-checklist/) - secondo il supporto di Mongo DB, molti elementi hanno un forte impatto sulle prestazioni. Per qualsiasi domanda, contatta direttamente il supporto MongoDB.
