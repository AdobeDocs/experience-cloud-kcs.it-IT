...
[&lt;- Precedente: Scaricamento del Dispatcher](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17493.html)
...
![Menu a discesa per l’interfaccia di authoring AEM nella schermata dell’editor del sito](assets/aem-page-properties-drop-down.png "aem-page-properties-menu a discesa")![pagina di dialogo delle proprietà della pagina aem](assets/aem-page-properties.png "aem-page-properties")

#### Ricerca contenuti classica:

![AEM proprietà della pagina della barra laterale dell’interfaccia utente classica siteadmin](assets/aem-page-properties-sidekick.png "aem-page-properties-sidekick")![Finestra di dialogo delle proprietà della pagina dell’interfaccia classica](assets/aem-page-properties-classic.png "aem-page-properties-classic")
...
![schermata della console di una voce di reindirizzamento nelle regole di risoluzione delle risorse](assets/vanity-resource-resolver-entry.png "voce di vanity-resource-resolver-entry")
...
![schermata del contenuto renderizzato da /libs/granite/dispatcher/content/vanityUrls.html](assets/vanity-url-component.png "vanity-url-component")
...
[Avanti -> Registrazione comune](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17914.html)