...
I clienti che utilizzano la versione 9 di mod_security non sono in grado di caricare file/risorse di grandi dimensioni. Questi devono essere caricati andando direttamente all’autore (ignorando il dispatcher).
