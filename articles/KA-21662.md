...
description: Scopri come caricare file/risorse di grandi dimensioni
solution: Experience Manager
product: Experience Manager
applies-to: Experience Manager
keywords: "KCS,mod_security, versione 9, impossibile caricare file/risorse di grandi dimensioni,"
...
Scopri come caricare file/risorse di grandi dimensioni aggiornandoli alla versione più recente di mod_security.
...
- mod_security (versione 9)

- Adobe Experience Manager/Adobe Managed Services

<b>Problema/Sintomi</b>

La versione 9 di mod_security non è in grado di caricare file/risorse di grandi dimensioni. Devono essere caricati navigando direttamente nell’istanza di authoring (ignorando il dispatcher).
