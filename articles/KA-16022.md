...
Consulta la pagina Descrizione del prodotto per la tolleranza per le chiamate API ([https://helpx.adobe.com/legal/product-descriptions/campaign-standard.html](https://helpx.adobe.com/legal/product-descriptions/campaign-standard.html) ); in caso contrario, consulta la risposta di seguito.
