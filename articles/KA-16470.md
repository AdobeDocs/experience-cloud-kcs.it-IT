---
title: "Audience Manager alla campagna"
...
10. Gli utenti dovrebbero essere in grado di accedere a Campaign V6 tramite Adobe ID
...
2. Sincronizza il database CRM con Campaign Il cliente deve impostare un processo in cui invia i propri dati CRM a Campaign. L&#39;e-mail CRM_ID sono i campi minimi da sincronizzare.
...
4. DTM legge la configurazione CRM_ID nello strumento &quot;marketing cloud ID service&quot;. L&#39;elemento dati hashed_email è configurato in DTM leggendo il CRM_ID disponibile in dataLayer.
...
L’sFTP creato per AAM deve essere configurato con Adobe Campaign in modo che Campaign possa inviare e richiamare segmenti da AAM. Le credenziali sFTP ti verranno fornite dall’Assistenza clienti Adobe o dal tuo rappresentante Adobe. Durante il provisioning delle posizioni ftp-in e ftp-out vengono fornite e utilizzate da campaign per inviare audience a segmenti AAM e onboard rispettivamente da AAM a campagna.
...
6. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Creare le origini dati e le destinazioni con
...
7. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Configurare le origini dati in Adobe Campaign Le origini dati vengono quindi configurate in Adobe Campaign. Verranno create due origini dati nell’interfaccia utente di Adobe Campaign; uno basato su ID dichiarato o ID cliente con hash e l&#39;altro su Marketing Cloud ID o requestor UID. L’ID di destinazione corrispondente a ciascun ID viene aggiunto nei rispettivi campi. Ad esempio, l’ID di destinazione per AAM destinazione Adobe Campaign - Declared ID viene aggiunto nell’impostazione dell’origine dati con chiave di riconciliazione come ID cliente con hash.
...
8. Tracciare il comportamento degli utenti sul sito Nel seguente caso d&#39;uso, la parola chiave di ricerca utilizzata da un cliente viene acquisita in evar2 e un acquisto di prodotti come evento di acquisto in Analytics. Il flusso seguente è basato sull&#39;inoltro lato server delle chiamate AA a AAM. Nella pagina di ricerca, acquisiamo il parametro &quot;q&quot; e lo mettiamo in un elemento dati:
...
Quindi, acquisiamo anche l&#39;evento &quot;purchase&quot; in analytics sulla pagina di ringraziamento:
...
A questo punto, siamo in grado di tenere traccia dei nostri clienti e di creare segmenti in Audience Manager. Inoltre, abbiamo assicurato che sia Audience Manager che Campaign stanno raccogliendo gli utenti con lo stesso CRM_ID.

9. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Creare segmenti in in base al comportamento dell&#39;utente, quindi creare le seguenti caratteristiche: &quot;Ha cercato l&#39;inverno&quot;:
...
10. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Spingere il segmento in Campaign Per condividere un pubblico AMC con la campagna, la configurazione deve essere eseguita in Adobe Campaign una volta creato il segmento in. Inizia creando un pubblico condiviso in Adobe Campaign e seleziona il segmento AMC dall’elenco dei segmenti. È necessario creare due tipi di pubblico condivisi in base a MID e ID dichiarato in campaign. Una volta completata la configurazione, i segmenti possono essere visualizzati come mappati automaticamente alle rispettive destinazioni in AAM.
...
11. Condividi un pubblico di una campagna con AAM tramite AMC Per condividere un pubblico di una campagna con AAM tramite AMC, è necessaria la seguente configurazione in Adobe Campaign. Seleziona Flussi di lavoro tecnici di produzione dall’opzione del menu Amministrazione nell’interfaccia utente della campagna. Fai clic sui nuovi flussi di lavoro tecnici, trascina la query, aggiorna il pubblico condiviso e quindi termina.
...
In campaign, crea prima un elenco basato su un pubblico. Questo è in &quot;elenchi&quot;:
...
La finestra a comparsa ora ti consente di selezionare un pubblico di marketing cloud. Scegli &quot;search_for_Winter_did_not-buy&quot;:
...
Potresti non aver effettuato l&#39;accesso utilizzando il tuo Adobe ID per la campagna. Se hai effettuato l’accesso utilizzando il tuo Adobe ID, assicurati di essere stato aggiunto al prodotto Libreria tipi di pubblico nell’interfaccia utente di Marketing Cloud Enterprise Console.
...
3. Non mappare mai i segmenti sulla destinazione della campagna dall’interfaccia utente AAM &#x200B;
