---
title: Errore "Impossibile connettersi a Brand Portal con \"JWT scaduto\" | AEM"
description: "Scopri come risolvere i problemi dopo la configurazione dell’integrazione di Adobe Experience Manager (AEM) Assets con Brand Portal."
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager Assets,Experience Manager"
keywords: "KCS, connect, Brand Portal, agente di replica, JWT scaduto, AEM, Adobe Experience Manager, 6.2, error, JSON Web Token"
...
Se ricevi il messaggio di errore dopo aver configurato l’integrazione di Adobe Experience Manager (AEM) Assets con Brand Portal *JWT è scaduto*, è necessario impostare un orario valido per il sistema operativo o utilizzare il protocollo NTP (Network Time Protocol).
...
Dopo la configurazione dell’integrazione di AEM Assets con Brand Portal, qui in [Panoramica di Experience Manager Assets Brand Portal: configurare Experience Manager Assets con Brand Portal](https://experienceleague.adobe.com/en/docs/experience-manager-brand-portal/using/introduction/brand-portal#configure-brand-portal) nella documentazione AEM,
...
La differenza causa la scadenza del JWT (JSON Web Token).
...
2. Modificare l&#39;ora in un&#39;ora valida o utilizzare il protocollo NTP (Network Time Protocol).
