...
keywords: "KCS, da JWT a OAuth Server, JWT, da server a server OAuth"
...
Le credenziali dell’account di servizio (JWT) sono state dichiarate obsolete e sostituite dalle nuove credenziali server-to-server OAuth. Le nuove credenziali semplificano lo sviluppo e la gestione di applicazioni Adobi. Elimina inoltre la necessità di ruotare periodicamente i certificati e funziona come strumento preconfigurato utilizzando le librerie OAuth2 standard. 
