---
title: "Ottimizzare la cache di Dispatcher"
...
# Ottimizzare la cache di Dispatcher
...
Funzionamento del caching di Dispatcher
...
5. <b>Memorizza nella cache pagine di errore</b> - Utilizzo della <b>[DispatcherPassError 1](https://helpx.adobe.com/it/experience-manager/dispatcher/using/dispatcher-install.html#ApacheWebServer) </b>(specifica per server web Apache) per distribuire le pagine di errore, ad esempio 404, dalla cache del dispatcher.
...
7. <b>Abilita [/serveStaleOnError](https://helpx.adobe.com/it/experience-manager/kb/ServeStaleContentOnError.html)</b> nella configurazione /cache, distribuisci il vecchio file di cache quando le istanze AEM presentano errori.
...
11. <b>Memorizza il contenuto nella cache il più a lungo possibile</b> e <b>riduci le richieste che tornano ad AEM</b>. Ottimizza le richieste di svuotamento abilitando il [recupero](https://helpx.adobe.com/experience-manager/kb/optimizing-the-dispatcher-cache.html#refetching-flush) dello svuotamento su tutti gli agenti di svuotamento.  Oppure utilizza [<b>/enableTTL</b>](https://helpx.adobe.com/experience-manager/kb/optimizing-the-dispatcher-cache.html#use-ttls) e imposta <b>Cache-Control: max-age=...</b> per memorizzare i file nella cache il più a lungo possibile.  Per ulteriori informazioni su questo argomento, vedi [di seguito](https://helpx.adobe.com/experience-manager/kb/optimizing-the-dispatcher-cache.html#use-ttls).
...
Spiegazione più dettagliata del recupero dello scaricamento
