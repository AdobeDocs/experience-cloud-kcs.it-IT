...
2. Aggiungere questa versione del nodo come <b>devDependencies</b> nel file `package.json` del modulo che non è stato possibile generare. Nell’esempio precedente, è UI Frontend.<br>
