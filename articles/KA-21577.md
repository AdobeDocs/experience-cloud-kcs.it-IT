...
keywords: “KCS, Cloud Manager, Generare un pacchetto Maven”
...
1. Trovare la versione del nodo in uso nel reattore `pom.xml`. Esempio seguente = 16.14.0 `pom.xml`:<br>
...
2. Aggiungere questa versione del nodo come <b>devDependencies</b> nel file `package.json` del modulo che non è stato possibile generare. Nell’esempio precedente, è l’interfaccia utente front-end.
