...
description: "Scopri come risolvere il problema di connessione ad Adobe Analytics in Power BI. Controllare l'autorizzazione per lo strumento Web Service Access Analytics."
solution: Analytics
product: Analytics
