...
Le modifiche in corso hanno a che fare con le connessioni HTTPS nell’istanza (ad esempio, connessioni alla console e chiamate API). Non ci sono modifiche alla configurazione SMTP su TLS (invio e-mail).
