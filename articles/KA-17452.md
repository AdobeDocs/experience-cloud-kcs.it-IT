...
- Se il comando jstack (`jstack -l <pid> >> threaddumps.log`) genera l&#39;errore `[` 1`]`  di seguito, esegui il comando come utente proprietario del processo java. Ad esempio:<br>\
