...
Se utilizzi un prodotto Adobe Experience Manager, puoi installare [questo strumento](https://helpx.adobe.com/experience-manager/kb/thread-dumps-collection-analysis.html) per avere una semplice interfaccia utente per la generazione delle immagini thread.
