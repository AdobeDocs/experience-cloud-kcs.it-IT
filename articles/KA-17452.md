...
keywords: "KCS,JVM,immagini di thread"
...
<b>Come prendere i dump di thread da una JVM su Linux, UNIX o Windows?</b>
...
`[` 1`]`  [TDA - Analizzatore di dump dei thread](https://github.com/irockel/tda) su irockel/tda su Github.com.
`[` 2`]`  [Analizzatore di dump di thread Java](https://fastthread.io/) su FastThread.
`[` 3`]`  [IBM Thread e Monitor Dump Analyzer per Java](https://www.ibm.com/support/knowledgecenter/en/SSLLVC_5.0.0/com.ibm.esupport.tool.tmda.doc/docs/readme.htm) nella documentazione relativa all&#39;Assistente al supporto IBM.
