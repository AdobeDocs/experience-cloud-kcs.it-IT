...
![la linea di base apache include l’ordine. apache binary inizia con httpd.conf che esegue un includeoptional to the conf.d/*.conf e conf.module.d/* directory .conf](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/Apache-Webserver-Baseline-Includes.png)
...
![gli host virtuali ams includono elementi secondari. Questa immagine mostra come un file .vhost include file da variabili, whitelist e riscrive cartelle](https://helpx.adobe.com/content/dam/kb/en/ams-dispatcher-manual/Apache-Webserver-AMS-Vhost-Includes.png)
