...
[&lt;- Precedente: Layout dei file di base](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17502.html)
...
Come puoi vedere sopra, questo include il livello superiore `dispatcher.any` file per il modulo dispatcher per raccogliere i file di configurazione da `/etc/httpd/conf.dispatcher.d/dispatcher.any`
...
![Questa immagine mostra come un file .vhost include file da variabili, elenchi consentiti e cartelle di riscrittura](assets/Apache-Webserver-AMS-Vhost-Includes.png "Apache-Webserver-AMS-Vhost-Includes")
...
[Successivo -> Informazioni sulla cache](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17912.html)