...
description: Scopri il problema di Adobe Experience Manager quando il messaggio non è internazionalizzato.
...
Il problema è un messaggio che non è internazionalizzato. Il messaggio di errore &quot;Invalid date - The value must be of date datatype&quot; (Data non valida - Il valore deve essere di tipo dati) è in inglese anche se dovrebbe essere in tedesco, che è la lingua del browser del cliente.

La verifica della clientlib tedesca /libs/fd/af/runtime/clientlibs/I18N/de/javascript/LogMessages.js rileva che il messaggio è in inglese e contiene anche un segnaposto {0}, il che significa che parte del messaggio è dinamica.
