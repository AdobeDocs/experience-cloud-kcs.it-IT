...
description: "Scopri come gestire le voci di registro comuni in Adobe Experience Manager."
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager"
keywords: "KCS, AEM, registri comuni, livello cache, voce, Adobe Experience Manager"
...
Per ulteriori informazioni, consulta [Manuale di Adobe Managed Services Dispatcher](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17490.html) nella guida dei Tutorials dell’AEM.
...
Questo significa che viene misurato il recupero dal livello di rendering rispetto a quello dalla cache. Se desideri ottenere un valore superiore all’80% dalla cache, segui la documentazione [qui](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17458.html):
