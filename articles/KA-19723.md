...
La seguente traccia dello stack viene lanciata durante la migrazione dei contenuti da AEM v6.1 a v6.5:
...
Esegui prima la migrazione a AEM v6.3, quindi a v6.5.
