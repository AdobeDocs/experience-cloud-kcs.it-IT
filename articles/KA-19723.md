...
La seguente traccia dello stack viene lanciata quando durante la migrazione dei contenuti da AEM v6.1 a 6.5:
...
Esegui la migrazione a AEM v6.3 prima di 6.5.
