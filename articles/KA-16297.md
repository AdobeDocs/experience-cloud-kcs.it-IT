---
title: Recupero del modello AEM da [!DNL Campaign] console
...
# Recupero del modello AEM da [!DNL Campaign] console

## Descrizione


Descrizione del problema = Quando si sincronizzano AEM modelli in [!DNL Campaign], viene visualizzato il seguente errore:
...
I diritti di replica devono essere concessi all’utente AEM della campagna, nel server AEM.  Abbiamo dato i diritti di lettura/scrittura/replica al [!DNL Campaign]L’utente AEM in /content/campaign e /content/dam percorsi in cui erano presenti le risorse della campagna.
