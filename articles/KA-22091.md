---
title: '"Pipeline non riuscita con errore \"Manca la proprietà end_aem_createsegmentstore\"'
...
# Pipeline non riuscita con errore &quot;Manca la proprietà end_aem_createsegmentstore&quot;

## Descrizione {#description}

La pipeline CI/CD continua a generare errori durante la fase di &quot;Distribuzione nello sviluppo&quot;. <br><br>I registri di distribuzione non mostravano alcun errore a causa della base di codice, ma sono presenti i seguenti errori:<br><br> <br><br> <br><br> <br><br>`[` 1`]`  
...
Durante il controllo della pipeline è stato rilevato un errore di tipo &quot;errorCode&quot;: &quot;BLOCKED_QUEUE&quot;.

Ciò significa che la coda di replica è bloccata e impedisce l’installazione di contenuto mutabile aggiuntivo.

Nei registri, gli errori `[` 1`]`  sono presenti durante il periodo di implementazione. Molto probabilmente il nodo - `[` 2`]`  non è presente nel server di pubblicazione e/o di anteprima e la replica non riesce.
