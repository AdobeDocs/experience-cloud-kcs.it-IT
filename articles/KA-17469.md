...
Puoi trovare gli ultimi hotfix su [Condivisione pacchetti di Adobe](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html).
...
<br> 
5. Riavvia Adobe Experience Manager e monitora i tuoi file di log per i messaggi di log INFO da org.apache.jackrabbit.oak.plugins.index.  Se vuoi vedere altri dettagli sull&#39;indicizzazione, vai su /system/console/slinglog UI e abilita il debug level logging per org.apache.jackrabbit.oak.plugins.index.
