...
1. Se il sito dispone di contenuto personalizzato/dinamico:
   ...
   1. Utilizzo [[!DNL Apache] Sling Dynamic Includes](https://helpx.adobe.com/experience-manager/kt/platform-repository/using/sling-dynamic-include-technical-video-setup.html) per suddividere il contenuto in modo che diverse parti della pagina possano essere memorizzate nella cache per diversi periodi di tempo.
