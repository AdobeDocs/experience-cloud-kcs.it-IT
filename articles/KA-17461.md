...
3. Ottimizzare le librerie client.
   ...
   3. [Incorporare le librerie client](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html?lang=it) per minimizzare e ridurre i file js e css.
