...
- Utilizza il <b>Segui flusso TCP</b> per isolare il flusso su cui si sta lavorando.<br><br>    La finestra di testo di colore rosso/blu che viene visualizzata è utile solo per i protocolli di testo che non sono rilevanti per SMPP, quindi puoi chiuderla.
