...
- Utilizza un filtro di visualizzazione sulla porta dell’SMS-C.<br><br>    Ad esempio, se l’SMS-C utilizza la porta 10000, utilizza il filtro seguente:
   `tcp.port == 10000`
...
- Utilizza la <b>Segui flusso TCP</b> strumento per isolare il flusso su cui stai lavorando.<br><br>    La finestra di testo di colore rosso/blu che viene visualizzata è utile solo per i protocolli di testo che non sono rilevanti per SMPP, quindi puoi chiuderla.
...
![smp3](https://helpx.adobe.com/content/dam/help/en/campaign/kb/smpp-protocol-wireshark/jcr_content/main-pars/image_388497282/smpp3.png "smpp3")
