...
La coda di replica viene periodicamente bloccata per uno dei nostri clienti AEMaaCS. Questo articolo descrive la soluzione alternativa suggerita dal team ingegneristico che può essere eseguita nell’interfaccia utente utilizzando le autorizzazioni di amministratore.
...
Una delle code di replica dei clienti AEMaaCS si è bloccata periodicamente a causa dell’eccezione javax.jcr.NamespaceException: Prefisso spazio dei nomi sconosciuto: eccezione ns22_.
...
Per sbloccare la coda è sufficiente eliminare la richiesta dall’interfaccia utente della coda di distribuzione Golden-Publish. Suggerisci al cliente di eseguire i passaggi seguenti.
