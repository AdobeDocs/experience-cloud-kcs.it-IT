---
title: "Impossibile selezionare Adobe Target come soluzione cloud per una configurazione IMS"
...
# Impossibile selezionare Adobe Target come soluzione cloud per una configurazione IMS
...
Ambiente: AEM on-premise



Il cliente sta tentando di creare una configurazione Adobe Target IMS per integrare l’AEM con Adobe Target.

Tuttavia, ogni volta che selezioni &quot;Adobe Target&quot; come soluzione Cloud per la configurazione IMS, viene visualizzato l’errore &quot;Impossibile recuperare i certificati: l’ID utente fornito non identifica un utente esistente&quot; e non è possibile creare la configurazione.

Questo problema si verifica solo per la soluzione Adobe Target.



Passaggi per riprodurre l’errore:

1. Vai a Strumenti `>`  Sicurezza `>`  Configurazioni IMS `>`  Crea
2. Seleziona Target come soluzione

Viene visualizzato un errore nell’interfaccia utente &quot;Impossibile recuperare il certificato. L’ID utente fornito non identifica un utente esistente.&quot;

Nei registri l’unico errore relativo a questo problema è `[` 1`]` .
...
Durante il controllo delle autorizzazioni per gli utenti &quot;target-imsconfig-service&quot; e &quot;targetservice&quot;, è stato notato che a target-imsconfig-service non erano assegnate ACE.
...
Percorso: /home/users/system/target-imsconfig-service

Autorizzazione: consenti

Privilegi: jcr:read; rep:write
