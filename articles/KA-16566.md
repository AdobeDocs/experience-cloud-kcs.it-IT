...
- `name` e `indexPath` le proprietà facilitano la comprensione dei registri di indice, in quanto taggerebbero i messaggi di log con il percorso o il nome dell&#39;indice. Esempio:
