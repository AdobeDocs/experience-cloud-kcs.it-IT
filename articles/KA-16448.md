...
6. Modifica i percorsi in linea in modo che corrispondano all’istanza (se necessario, aggiungi `segment-old:` prima del percorso, come puoi vedere qui [https://jackrabbit.apache.org/oak/docs/migration.html](https://jackrabbit.apache.org/oak/docs/migration.html)): `/opt/aem-source/crx-quickstart/repository /opt/aem-destination/crx-quickstart/repository`
