...
<br>Applicare le modalità `ALL_OR_EMPTY/ALL` e *null* values<br>
...
<br>Applicare le modalità: `INSTANCES`, `_instances: 0` e *null* values<br>
...
<br>Miglioramenti che possono influenzare i clienti con `ft-sites-97` abilitato<br>
...
<br>gestione null con condizioni che verificano la non uguaglianza<br>
...
<br>Operatore filtro `NOT_AT` con valori data/ora<br>
...
<br>Array: `INSTANCES` con `_instances: 0` non funziona correttamente<br>
