...
description: "Scopri come risolvere il problema se Stage Publisher non funziona correttamente e non può pubblicare contenuti in questa istanza."
solution: Experience Manager
product: Experience Manager
applies-to: "Experience Manager"
keywords: "KCS, impossibile pubblicare il contenuto, Risoluzione dei problemi, AEM, Adobe Experience Manager, error.log"
...
Il problema è stato risolto dopo la replica della /var/structure da Production a Stage e il riavvio dell’AEM in Stage Publishers.
...
<b>Problema</b>
L&#39;autore dello stage non funziona correttamente e non è possibile pubblicare il contenuto in questa istanza.

Questi tipi di errori vengono visualizzati in error.log:
...
L’errore nel registro non è correlato al caching, ma viene visualizzato quando l’utente del servizio non dispone delle autorizzazioni corrette per il percorso `/var/discovery` nell&#39;Autore o nell&#39;Editore.

Durante la verifica delle autorizzazioni per `/var/discovery` percorso, è stato rilevato che nell’editore Stage non era presente `discovery` cartella in `/var`, e c&#39;erano anche molti contenuti mancanti.

Mentre il `/var` nella cartella dell’editore di produzione aveva più di 20 elementi secondari, il `/var`nella cartella dell’editore di Stage ne erano presenti solo 2: <b>replica</b> e <b>sling</b>.

Il problema è stato risolto dopo la replica di `/var/structure` dalla fase di produzione a quella di staging e riavvio dell’AEM su Stage Publishers.
