...
Uno dei nostri clienti si lamenta del fatto che l’editore di Stage non funziona correttamente e che non può pubblicare contenuti in questa istanza. I seguenti errori sono stati visualizzati in error.log:
...
L’errore nel registro non è correlato al caching, ma viene visualizzato quando l’utente del servizio non dispone delle autorizzazioni appropriate per il percorso /var/discovery nell’istanza di authoring o di pubblicazione.

Dopo ulteriori indagini, mentre si chiedeva al cliente di verificare le autorizzazioni per il percorso /var/discovery, è stato rilevato che nell’editore Stage non esisteva alcuna cartella &quot;discovery&quot; in /var e che mancavano molti contenuti.

Mentre la cartella /var nell’editore di produzione aveva più di 20 elementi secondari, la cartella /var nell’editore di stage aveva solo 2 &quot;replication&quot; e &quot;sling&quot;.
